            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <ObjectionItem
                        ...
                        answer="18 of our 33 pathways require zero coding. And for tech roles, we start from absolute basics. If you can use email, you can learn with T6."
                    />
                    <ObjectionItem
                    ...
                    <ObjectionItem
                        ...
                        answer="450+ companies are already hiring our graduates. Blockchain-verified credentials from MIT and Tsinghua carry weight. Plus, your portfolio of real projects speaks louder than any certificate."
                    />
                </div>

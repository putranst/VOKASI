...
const MOCK_STUDENTS = [
  { id: "1", name: "Ahmad Rizki Pratama", email: "ahmad@student.vokasi.id", enrolledCourses: 3, completionRate: 78, lastActive: "2 hours ago", status: "active" },
  { id: "2", name: "Siti Nurhaliza", email: "siti@student.vokasi.id", enrolledCourses: 4, completionRate: 92, lastActive: "Just now", status: "active" },
  { id: "3", name: "Budi Santoso", email: "budi@student.vokasi.id", enrolledCourses: 2, completionRate: 45, lastActive: "3 days ago", status: "at_risk" },
  { id: "4", name: "Dewi Kusumawardani", email: "dewi@student.vokasi.id", enrolledCourses: 3, completionRate: 85, lastActive: "1 hour ago", status: "active" },
  { id: "5", name: "Rizki Andriansyah", email: "rizki@student.vokasi.id", enrolledCourses: 1, completionRate: 33, lastActive: "1 week ago", status: "inactive" },
];

/**
 * VOKASI Puck Config — Educational Component Registry
 * vokasi2.prd §6.1
 *
 * Maps the 10 educational block types to @puckeditor/core Config format.
 */
...
export const vokasiPuckConfig: Config = {
  components: {
    ...
    SocraticChat: {
      ...
      defaultProps: {
        seedQuestion: "What do you think happens when…?",
    ...
    CodeSandbox: {
      ...
      defaultProps: {
        ...
        instructions: "Complete the function above.",
        testCases: "",
      },
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    PeerReviewRubric: {
      ...
      defaultProps: {
        ...
        instructions: "Review your peer's submission using the criteria below.",
        criteria: [
          {
            criterion: "Clarity",
            maxPoints: 10,
            description: "Is the submission clear and well-structured?",
          },
          {
            criterion: "Depth",
            maxPoints: 20,
            description: "Does the submission demonstrate deep understanding?",
          },
        ],
      },
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    ReflectionJournal: {
      ...
      defaultProps: {
        prompt: "What was the most surprising thing you learned today?",
        minWords: 100,
    ...
    Assignment: {
      ...
      defaultProps: {
        title: "Assignment",
        description: "Complete the tasks described below.",
    ...
    DiscussionSeed: {
      ...
      defaultProps: {
        ...
        seedPost: "Share your perspective on this topic.",
        requiredReplies: 2,
        gradingNotes: "Substantive replies required.",
      },
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
